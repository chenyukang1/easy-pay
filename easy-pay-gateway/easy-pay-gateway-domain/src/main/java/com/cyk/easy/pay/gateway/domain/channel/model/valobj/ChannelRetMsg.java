...
public class ChannelRetMsg implements Serializable {
    ...
    @Serial
    private static final long serialVersionUID = 6590023845869536169L;
    ...
    public ChannelRetMsg(ChannelState channelState, String channelOrderId, String channelErrCode,
