package com.cyk.easy.pay.merchant.infrastructure;
...
class CodeGenTest {
    ...
    public static final String THIS_MODULE_NAME = "easy-pay-merchant/easy-pay-merchant-infrastructure"; //当前项目名称
    public static final String PACKAGE_ROOT = "com.cyk.easy.pay.merchant.infrastructure"; //包根目录

    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/merchant?useUnicode=true&characterEncoding=UTF-8" +
            "&serverTimezone=GMT%2B8";
    public static final String DB_USERNAME = "root";
    public static final String DB_PASSWORD = "root";

    // 多个用,  拼接
    public static final String TABLE_NAMES = "t_sys_user";
    ...
    public static void main(String[] args) {
        ...
        pc.setServiceImpl("repository");  //serviceImpl 目录
